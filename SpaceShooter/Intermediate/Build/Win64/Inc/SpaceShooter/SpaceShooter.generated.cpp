...
void EmptyLinkFunctionForGeneratedCodeSpaceShooter() {}
	...
	IMPLEMENT_CLASS(ASpacyCamera, 1861541197);
	...
	IMPLEMENT_CLASS(ASpreadShotPowerup, 21322009);
	void ABasicEnemy::StaticRegisterNativesABasicEnemy()
	{
	}
	IMPLEMENT_CLASS(ABasicEnemy, 1523190470);
	...
	IMPLEMENT_CLASS(AWaveyEnemy, 3822900668);
...
// Cross Module References
	...
	UClass* Z_Construct_UClass_ASpacyCamera()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_CameraComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CameraComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(CameraComponent, ASpacyCamera), 0x00000000000a001d, Z_Construct_UClass_UCameraComponent_NoRegister());
	...
	UClass* Z_Construct_UClass_ASpreadShotPowerup()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_MeshComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(MeshComponent, ASpreadShotPowerup), 0x00000800000a001d, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
				UProperty* NewProp_ColliderComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ColliderComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ColliderComponent, ASpreadShotPowerup), 0x00000800000a001d, Z_Construct_UClass_USphereComponent_NoRegister());
	...
	UClass* Z_Construct_UClass_ABasicEnemy()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_MeshComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(MeshComponent, ABasicEnemy), 0x00000000000a001d, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_AProjectile()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_MeshComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(MeshComponent, AProjectile), 0x00000000000a001d, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
				UProperty* NewProp_ColliderComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ColliderComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ColliderComponent, AProjectile), 0x00000000000a001d, Z_Construct_UClass_USphereComponent_NoRegister());
				UProperty* NewProp_ExplosionSound = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ExplosionSound"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ExplosionSound, AProjectile), 0x00000000000a001d, Z_Construct_UClass_UAudioComponent_NoRegister());
				...
				MetaData->SetValue(NewProp_ExplosionSound, TEXT("ModuleRelativePath"), TEXT("Projectile.h"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	UFunction* Z_Construct_UFunction_AShip_Hit()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Hit"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x00420401, 65535, sizeof(Ship_eventHit_Parms));
			UProperty* NewProp_SweepResult = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("SweepResult"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(SweepResult, Ship_eventHit_Parms), 0x0000000008000182, Z_Construct_UScriptStruct_UEngineTypes_FHitResult());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bFromSweep, Ship_eventHit_Parms, bool);
			UProperty* NewProp_bFromSweep = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bFromSweep"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bFromSweep, Ship_eventHit_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bFromSweep, Ship_eventHit_Parms), sizeof(bool), true);
			UProperty* NewProp_TargetByIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TargetByIndex"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(TargetByIndex, Ship_eventHit_Parms), 0x0000000000000080);
			UProperty* NewProp_TargetComp = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TargetComp"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(TargetComp, Ship_eventHit_Parms), 0x0000000000080080, Z_Construct_UClass_UPrimitiveComponent_NoRegister());
			UProperty* NewProp_TargetActor = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TargetActor"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(TargetActor, Ship_eventHit_Parms), 0x0000000000000080, Z_Construct_UClass_AActor_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
			MetaData->SetValue(NewProp_SweepResult, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
			MetaData->SetValue(NewProp_bFromSweep, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
			MetaData->SetValue(NewProp_TargetByIndex, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
			MetaData->SetValue(NewProp_TargetComp, TEXT("EditInline"), TEXT("true"));
			MetaData->SetValue(NewProp_TargetComp, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
			MetaData->SetValue(NewProp_TargetActor, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_AShip()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_ParticleExhaust = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ParticleExhaust"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ParticleExhaust, AShip), 0x00000800000a001d, Z_Construct_UClass_UParticleSystemComponent_NoRegister());
				UProperty* NewProp_MeshComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(MeshComponent, AShip), 0x00000800000a001d, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
				...
				MetaData->SetValue(NewProp_ParticleExhaust, TEXT("Category"), TEXT("Particles"));
				MetaData->SetValue(NewProp_ParticleExhaust, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_ParticleExhaust, TEXT("ModuleRelativePath"), TEXT("Ship.h"));
				MetaData->SetValue(NewProp_MeshComponent, TEXT("Category"), TEXT("StaticMesh"));
				MetaData->SetValue(NewProp_MeshComponent, TEXT("EditInline"), TEXT("true"));
	...
	UClass* Z_Construct_UClass_AWaveyEnemy()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_MeshComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(MeshComponent, AWaveyEnemy), 0x00000000000a001d, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Navigation"));
